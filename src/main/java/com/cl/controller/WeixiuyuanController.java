...
public class WeixiuyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeixiuyuanEntity u = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("weixiuyuanzhanghao", username));
        if(u==null || !u.getWeixiuyuanmima().equals(password)) {
            return R.error("账号或密码不正确");
        }
		String token = tokenService.generateToken(u.getId(), username,"weixiuyuan",  "管理员" );
    ...
    public R register(@RequestBody WeixiuyuanEntity weixiuyuan){
    	...
    	WeixiuyuanEntity u = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("weixiuyuanzhanghao", weixiuyuan.getWeixiuyuanzhanghao()));
		if(u!=null) {
