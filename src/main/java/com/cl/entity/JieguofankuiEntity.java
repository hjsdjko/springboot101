...
public class JieguofankuiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JieguofankuiEntity() {
		
	}
	
	public JieguofankuiEntity(T t) {
		try {
	 ...
	 * 设置：结果反馈
	 */
	public void setJieguofankui(String jieguofankui) {
		this.jieguofankui = jieguofankui;
	}
	/**
	 * 获取：结果反馈
	 */
	public String getJieguofankui() {
		return jieguofankui;
	}
	/**
	 * 设置：跨表用户id
