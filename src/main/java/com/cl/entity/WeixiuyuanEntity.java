...
public class WeixiuyuanEntity<T> implements Serializable {
	 ...
	 * 设置：维修员密码
	 */
	public void setWeixiuyuanmima(String weixiuyuanmima) {
		this.weixiuyuanmima = weixiuyuanmima;
	}
	/**
	 * 获取：维修员密码
	 */
	public String getWeixiuyuanmima() {
		return weixiuyuanmima;
	}
	/**
	 * 设置：维修员姓名
	 */
